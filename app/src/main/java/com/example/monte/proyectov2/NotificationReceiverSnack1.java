...
public class NotificationReceiverSnack1 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,110,repIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, channelId).setAutoCancel(true).
                setContentIntent(pendingIntent).setContentTitle("Snack1").
