...
public class NotificationReceiverBedtime extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,160,repIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, channelId).setAutoCancel(true).
                setContentIntent(pendingIntent).setContentTitle("Bedtime").
                setContentText("Go eat").setSmallIcon(R.drawable.alarma);

        notificationManager.notify(160,builder.build());
