...
public class NotificationReceiverSnack3 extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context,150,repIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, channelId).setAutoCancel(true).
                setContentIntent(pendingIntent).setContentTitle("Snack3").
